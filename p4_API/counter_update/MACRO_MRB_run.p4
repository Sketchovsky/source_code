...
#define MRB_RUN_END(D) \
    update_##D##_1.apply(ig_md.d_##D##_base_32, ig_md.d_##D##_index1_16); \


#define MRB_RUN_1_KEY_1(D, KEY1) \
    d_##D##_sampling_hash_call.apply(KEY1, ig_md.d_##D##_sampling_hash_16); \
    d_##D##_tcam_lpm.apply(ig_md.d_##D##_sampling_hash_16, ig_md.d_##D##_base_32); \
    d_##D##_index_hash_call_1.apply(KEY1, ig_md.d_##D##_index1_16); \
    MRB_RUN_END(D) \


#define MRB_RUN_1_KEY_2(D, KEY1, KEY2) \
...
#define MRB_RUN_1_KEY_3(D, KEY1, KEY2, KEY3) \
...
#define MRB_RUN_1_KEY_4(D, KEY1, KEY2, KEY3, KEY4) \
...
#define MRB_RUN_1_KEY_5(D, KEY1, KEY2, KEY3, KEY4, KEY5) \
