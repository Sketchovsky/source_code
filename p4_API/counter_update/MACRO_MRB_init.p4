#define MRB_INIT_1(D, KEY, WIDTH, WIDTH_BITLEN, LEVEL_BITLEN) \
    ...
    LPM_OPT_MRB() d_##D##_tcam_lpm; \
    T1_INDEX_UPDATE_##WIDTH##() update_##D##_1; \


#define MRB_INIT_1_WITH_POLY(D, KEY, WIDTH, WIDTH_BITLEN, LEVEL_BITLEN, POLY1, POLY2) \
